...
- در پایتون پس از فشردن دکمه‌ی ویرایش، ربات منتظر مقدار جدید می‌ماند ولی در Worker
  باید فرمان `/editproduct` را دستی ارسال کنید. این مکالمه‌ی تعاملی هنوز پیاده
  نشده است.
